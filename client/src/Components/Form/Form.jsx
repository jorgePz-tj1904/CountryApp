...
const From=()=>{
    ...
    const handleSubmit = async(event)=>{
        ...
        const newErrors = validateForm(activityName, difficulty, duration, season, selectedCountry);
       setErrors(newErrors);
    ...
    return(
        <div className={styles.fondo}>
         ...
         <div className={styles.conteiner}>
            ...
            {
                done == false ? <form onSubmit={handleSubmit}>
                ...
                </form> : (<div><h2 id={styles.done}>Done!</h2> <NavLink id={styles.list} to='/activities'>Activities list</NavLink></div>)
            }
         </div>
        </div>
    )
